...
{
    public class GetContractorDto : IMapFrom<User>
    {
        ...
        public ContracorGenderDto Gender { get; set; }

        public string PhoneNumber { get; set; }

        public string Email { get; set; }

        public ContracorCityDto City { get; set; }

        public string Latitude { get; set; }

        public string Longitude { get; set; }

        public ContracorBusinessDto Business { get; set; }
        ...
        {
            profile.CreateMap<User, GetContractorDto>()
                .ForMember(d => d.Gender, opt => opt.MapFrom(s => new ContracorGenderDto
                {
                    GenderGuid = s.GenderCode.CodeGuid,
                    Name = s.GenderCode.DisplayName
                }))
                .ForMember(d => d.City, opt => opt.MapFrom(s => new ContracorCityDto
                {
                ...
                .ForMember(d => d.Business, opt => opt.MapFrom(s => new ContracorBusinessDto
                {
    ...
    public class ContracorGenderDto
    {
    ...
    public class ContracorBusinessDto
    {
